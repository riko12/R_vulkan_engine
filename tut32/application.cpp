/*
 * Application.cpp
 * Add the vulkan ApplicationInfo as variable in the class definition
 * Add createInstance clas member
 * ->Instantiate VkApplicationInfo appInfo
 * ->Set proper attributes
 * ->Instantiate VkInstanceCreateInfo createInfo
 * ->get and set to createInfo structure proper extensions
